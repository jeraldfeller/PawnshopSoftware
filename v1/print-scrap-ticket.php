...
$id = $_GET['customer_id'];
$last_id = $_GET['scrap_id'];

$employeeClass = new Employee();
$customer = $employeeClass->getCustomerByIdScrap($id, $last_id);
$items = $employeeClass->getScrapItem($id, $last_id);
        ...
        <div class="media">
            ...
            <div class="media-body">
                <ul class="breadcrumb">
                    ...
                    <li>Scrap Buying Ticket</li>
                </ul>
                <h4>Scrap Buying Ticket</h4>
            </div>
        </div><!-- media -->
    </div><!-- pageheader -->
                                ...
                                <div class="col-lg-12 print-table">
                                    ...
                                    <table class="body-table item-display">
                                        ...
                                        <tr class="border-thin">
                                            ...
                                            <th class="border-thin">Weight(in grams)</th>
                                        ...
                                        foreach ($items as $item){
                                            ...
                                            echo '<td class="border-thin">' . $item['weight'] . '</td>' . PHP_EOL;
                                        ...
                                        ?>
                                        <tr class="sum-border">
                                            <td colspan="2" class="no-border align-right table-padding-right">Grand Total</td><td class="border-thin">$<?php echo number_format($amount_paid, 2); ?></td>
                                        </tr>
