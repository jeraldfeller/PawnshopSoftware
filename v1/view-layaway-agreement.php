...
$layaway = $employeeClass->getLayawayByMonth($from, $to);
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <ul class="breadcrumb">
                                    ...
                                    <li>Layaway Agreements</li>
                                </ul>
                                <h4>Layaway Agreements</h4>
                            </div>
                        </div><!-- media -->
                    </div><!-- pageheader -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-primary mb30 align-center">
                                        <thead>
                                                ...
                                                <tbody>
                                                <?php echo $view->displayLayaway($layaway, 'active'); ?>
                                                </tbody>
                                    </table>
                                    </div>
                                </div>
