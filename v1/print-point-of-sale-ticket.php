...
$customer = $employeeClass->getCustomerByIdPointOfSale($id);
$items = $employeeClass->getPointOfSaleItemSold($id, $last_id);
$sub_total = $employeeClass->getPointOfSaleSum($id, $last_id);
$name = 'Guest';
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                                ...
                                <div class="col-lg-12 print-table">
                                    ...
                                    <table class="body-table item-display">
                                        ...
                                        foreach ($items as $item){
                                            ...
                                            echo '<td class="border-thin">$' . number_format($item['retail'], 2) . '</td>' . PHP_EOL;
                                            echo '<td class="border-thin">' . $item['quantity_sold'] . '</td>' . PHP_EOL;
                                            echo '<td class="border-thin">$' . number_format($item['retail'],2 ) . '</td>' . PHP_EOL;
                                            echo '</tr>' . PHP_EOL;
                    ...
                    <div class="panel-footer">
                        <button class="btn btn-primary" onclick="printDiv('printablediv')">Print POS Ticket</button>
                    </div><!-- panel-footer -->
                </div><!-- panel -->
