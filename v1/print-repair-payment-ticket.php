                            ...
                            <div id="printablediv">
                                <div class="col-lg-12 print-table">
                                    ...
                                    <table class="body-table item-display">
                                        ...
                                        <tr class="sum-border">
                                            <td colspan="3" class="no-border align-right table-padding-right">BALANCE DUE AT PICKUP</td><td class="border-thin">$<?php echo number_format($grand_total - $deposit, 2); ?></td>
                                        </tr>
                                        <tr class="sum-border">
                                            <td colspan="3" class="no-border align-right table-padding-right"><span class="bold">Amount Paid</span></td><td class="border-thin"><span class="bold">$<?php echo number_format($grand_total - $deposit, 2); ?></td>
                                        </tr>
                                        <tr class="sum-border">
                                            <td colspan="3" class="no-border align-right table-padding-right"><span class="bold">ENDING BALANCE</span></td><td class="border-thin">$0</td>
                                        </tr>
