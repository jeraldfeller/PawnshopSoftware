...
$id = $_GET['customer_id'];
$last_id = $_GET['sale_id'];
$employeeClass = new Employee();
$customer = $employeeClass->getCustomerByIdVehicleSale($id);
$items = $employeeClass->getVehicleSaleItemSold($id, $last_id);
$sub_total = $employeeClass->getVehicleSaleSum($id, $last_id);
$name = 'Guest';
        ...
        <div class="media">
            ...
            <div class="media-body">
                <ul class="breadcrumb">
                    ...
                    <li>Vehicle Sales Ticket</li>
                </ul>
                <h4>Vehicle Sales Ticket</h4>
            </div>
        </div><!-- media -->
    </div><!-- pageheader -->
                                ...
                                <div class="col-lg-12 print-table">
                                    ...
                                    <table class="border-thin header-table-1">
                                        <tr class="table-padding-left">
                                            ...
                                            <td class="border-thin"><span class="big-txt-2">RECIEPT</span> <br> Date: <?php echo $currentDate; ?> <br> Time: <?php echo $currentTime; ?></td>
                                    ...
                                    <table class="body-table item-display">
                                        ...
                                        <tr class="border-thin">
                                            <th class="border-thin">VIN #</th>
                                            <th class="border-thin">YEAR</th>
                                            <th class="border-thin">MODEL</th>
                                        ...
                                        foreach ($items as $item){
                                            ...
                                            echo '<td class="border-thin">' . $item['vin_no'] . '</td>' . PHP_EOL;
                                            echo '<td class="border-thin">' . $item['year'] . '</td>' . PHP_EOL;
                                            echo '<td class="border-thin">' . $item['model'] . '</td>' . PHP_EOL;
