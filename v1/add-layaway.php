...
$layaway_settings = $adminClass->getLayawaySettings();
...
if(isset($_POST['submit'])){
    ...
    if(isset($_POST['submit'])) {
        ...
        $last_id = $employeeClass->addLayaway($c_id, $sub_total, $tax, $total, $downpayment, 'active', $date_added, $layaway_settings[0]['maximum_days'], $layaway_settings[0]['grace_period'], $layaway_settings[0]['minimum_required']);
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <ul class="breadcrumb">
                                    ...
                                    <li>Add Layaway Agreement</li>
                                </ul>
                                <h4>Add Layaway Agreement</h4>
                            </div>
                        </div><!-- media -->
                    </div><!-- pageheader -->
                                        ...
                                        <div class="panel-body">
											...
											<div class="col-lg-3">
                                                    ...
                                                    <div class="input-group col-lg-12">
														...
														<span class="input-group-addon">$</span>
														<input type="text" class="form-control" value="0.00" id="downpayment" name="downpayment" onchange="calcGrandTotal();"/>
                                                    </div>
                                            </div>
...
<script>
    ...
    <script>
        ...
        function calcGrandTotal(){
			...
			downpayment = parseFloat(downpayment.replace(/[^\d\.]/, ''));
