...
$title = 'Title Pawn Payment Ticket';
...
$customer = $employeeClass->getCustomerByIdStaggardTitle($id, $last_id);

if($_GET['state'] == 2){
    $employeeClass->flushPartial($id, $last_id, 'title_pawn_tbl');
}
foreach($customer as $row)
{

    $loan_number = $row['tittle_pawn_id'];
        ...
        <div class="media">
            ...
            <div class="media-body">
                <ul class="breadcrumb">
                    ...
                    <li>Title Pawn Payment Ticket</li>
                </ul>
                <h4>Title Pawn Payment Ticket</h4>
            </div>
        </div><!-- media -->
    </div><!-- pageheader -->
                        ...
                        <div class="row">
                            <div id="printablediv">
                                <div class="col-lg-12 print-table">
                                    ...
                                    <div class="align-center"><span class="big-txt-2"><?php echo strtoupper($fname) . ' TITLE PAWN CONTRACT - Extension Payment Receipt'; ?></span></div>
                                    <table class="border-thin header-table-1">
                                        <tr class="table-padding-left">
                                            ...
                                            <td class="border-thin align-left" colspan="2">Contract Number <br> <br> <?php echo $payment_id; ?></td>
                                        </tr>
                                        <tr class="table-padding-left">
                                        ...
                                        <tr  class="table-padding-left" style="border-right: 0;">
                                            ...
                                            <td valign="top" style="border: 0;" colspan="4" rowspan="5" >
                                                    ...
                                                    <tr class="table-padding-left align-left">
                                                        <td><span class="bold">AMOUNT YOU PAID TODAY</span> <br>

                                                            $<?php echo number_format($amount_paid, 2); ?>
                                                        </td>
                                                    </tr>
													<tr class="table-padding-left align-left">
                                                        <td><span class="bold">PENALTY</span> <br>

                                                            $<?php echo number_format($penalty, 2); ?>
                                                        </td>
                                                    </tr>
                                                    <tr class="table-padding-left align-left">
                                                        <td>BALANCE AMOUNT REFINANCE<br>
                                                            The dollar amount the credit will cost you.
                                                            <br>
                                                            $<?php
                                                                if($_GET['state'] == 1){
                                                                    echo number_format($total_loan, 2);
                                                                }
                                                                else{
                                                    ...
                                                    <tr class="table-padding-left align-left">
                                                        <td>TOTAL OF PAYMENTS<br>
                                                            ...
                                                            if($_GET['state'] == 1){
                                                                ...
                                                                echo number_format($remaining + $interest_accured - $penalty, 2);
                                                            }
                                        ...
                                        <tr class="table-padding-left border-thin">
                                            <?php if ($grand_total == 0) {
                                                echo '<td class="border-thin align-center" colspan="3"><span class="bold">PAID IN FULL</span>';
                                            }
                                            else{
                                                echo '<td class="border-thin align-center" colspan="3"><span class="bold">YOU HAVE CHOSEN TO EXTEND YOUR TITLE PAWN</span> <br> You have chosen to extend your title pawn agreement by paying less than the amount that is required to pay the account in full. Your payment, refinance, and extension details are listed to the right. If you have any questions or concerns please do not hesitate to ask. We will gladly assist in helping you fully understand this agreement.<br>';
                                            }?>
