<?php $host = 'http://correllsoftware.com/'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <link href="<?php echo $host; ?>/css/morris.css" rel="stylesheet">
    <link href="<?php echo $host; ?>css/select2.css" rel="stylesheet" />
    <link href="<?php echo $host; ?>css/simple-line-icons.css" rel="stylesheet" />
    <link href="<?php echo $host; ?>css/jquery.gritter.css" rel="stylesheet">
    <link href="<?php echo $host; ?>css/bootstrap-timepicker.min.css" rel="stylesheet" />
    <link href="<?php echo $host; ?>css/bootstrap-switch.min.css" rel="stylesheet" />
    <script src="<?php echo $host; ?>js/jquery-1.11.1.min.js"></script>
    <script src="<?php echo $host; ?>js/jquery-ui-1.10.3.min.js"></script>
    <link href="<?php echo $host; ?>css/style.datatables.css" rel="stylesheet">
    ...
    <div class="mainwrapper">
        <div class="leftpanel">
            ...
            <ul class="nav nav-pills nav-stacked">
				...
				if($_SERVER['PHP_SELF'] == '/system-admin/accounts.php'){$accounts_class = 'class="active"';}else{$accounts_class = '';}
				...
				?>
					...
					<li <?php echo $accounts_class; ?>><a href="accounts"><i class="fa fa-credit-card"></i> <span>Accounts</span></a></li>
